  ...
  if (guilds.length === 0) {
    return (
      <div className="text-center py-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-full bg-background-700 mb-4">
          <svg
        ...
        <p className="text-background-400 mb-6 max-w-md mx-auto">
          You need to have admin permissions in a Discord server to manage the bot.
        </p>
        <a
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {guilds.map((guild) => (
        <ServerCard
          ...
          scheduleCount={guild.scheduleCount}
        />
      ))}
    </div>
  );
